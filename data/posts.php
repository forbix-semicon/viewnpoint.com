...
return [
    [
        "slug" => "gear-types-ratios-online-calculator",
        "title" => "Gear Types Explained: Ratios, Angles, and an Online Calculator",
        "path" => "/gear-types-ratios-online-calculator",
        "excerpt" => "Spur, helical, herringbone, hypoid, planetary, worm, and more — with equations, transfer ratios, static 3D photos, and an online gear calculator.",
        "snapshot" => "Online gear calculator with sliders: change teeth, module, and speed; browse silver/gold gear-type photos and design equations.",
        "image" => "/blog/gears/gear-types-ratios-online-calculator.jpg",
        "readTime" => "18 min read",
        "published" => "2026-07-18",
        "author" => "Rajiv Nair",
        "heroBadge" => "Machines & Mechanisms",
        "heroSubheading" => "Slide teeth and module. Watch diameters, center distance, and speed ratio move in real time.",
        "seoDescription" => "Gear types explained with 3D photos and equations: spur, helical, herringbone, bevel, hypoid, planetary, worm, screw gear, coupling. Online gear ratio calculator with sliders.",
        "keywords" => "online gear calculator, gear types explained, herringbone gear, hypoid gear, planetary gear, spur bevel worm, screw gear, module pitch diameter",
        "styles" => ["gears-lab.css"],
        "scripts" => ["gears-lab.js"],
        "hideHeroImage" => true,
    ],
    [
        ...
        "snapshot" => "Online Fourier calculator: pick a square, saw, or custom mix, set harmonics, and watch time and frequency plots update.",
        ...
        "seoDescription" => "Fourier transform explained in easy English with an online calculator: Fourier series, frequency spectrum, square and sawtooth waves, custom harmonic inputs, and labeled X-Y axes.",
        "keywords" => "Fourier transform explained, Fourier series online calculator, frequency spectrum graph, square wave Fourier, sine wave harmonics, Fourier transform calculator, what is Fourier transform",
